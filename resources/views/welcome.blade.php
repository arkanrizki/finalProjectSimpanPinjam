            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    @if (Route::has('login'))
                        <div>
                            @auth
                                <a class="navbar-brand" href="{{ url('/admin-dashboard/koperasi') }}" style="color:#8EDFFF ;font-size: 64px; font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; border-radius: 120px 90px 60px 30px/30px 60px 90px 120px; background-color: white">
