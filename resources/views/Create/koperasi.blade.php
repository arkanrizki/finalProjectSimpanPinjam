...
@section('content')
    <div class="container" style="background-color: white; border-radius: 10px;">
        <div class="row "> <!--justify-content-center-->
            <div class="col-12">
                <h1 class="mt-3">Tambah koperasi</h1>
                <hr>
                <form method="POST" action="/koperasi">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control @error('nama_bendahara') is-invalid @enderror" id="nama_bendahara" name="nama_bendahara" placeholder="masukkan nama bendahara" value="{{old('nama_bendahara')}}">
                        @error('nama_bendahara') <div class="invalid-feedback"> {{$message}} </div> @enderror
                    </div>
                    <div class="form-group my-3">
                        <label for="no_telpon">Nomor Telepon</label>
                        <input type="text" class="form-control @error('no_telpon') is-invalid @enderror" id="no_telpon" name="no_telpon" placeholder="masukkan no telepon" value="{{old('no_telpon')}}">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control @error('id_koperasi') is-invalid @enderror" id="id_koperasi" name="id_koperasi" placeholder="masukkan id koperasi" value="{{old('id_koperasi')}}">
                        @error('id_koperasi') <div class="invalid-feedback"> {{$message}} </div> @enderror
                    </div>
                    <button type="submit" class="btn bg-primary my-3" style="color: white">Tambah Data</button>
                    <a href="{{ url('/datakoperasi') }}" class="btn bg-warning my-3" style="color: white">Lihat Data</a>
