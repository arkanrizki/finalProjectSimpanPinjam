            ...
            <nav class="header-nav ms-auto">
                <ul class="d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        >
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="<?= asset('admin/assets/img/messages-1.jpg') ?>') ?>"
                                        alt=""
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="<?= asset('admin/assets/img/messages-2.jpg') ?>"
                                        alt=""
                                        class="rounded-circle"
                                    />
                                    <div>
                            ...
                            <li class="message-item">
                                <a href="#">
                                    <img
                                        src="<?= asset('admin/assets/img/messages-3.jpg') ?>"
                                        alt=""
                                        class="rounded-circle"
                                    />
                                    <div>
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        >
                            <img
                                src="<?= asset('admin/assets/img/profile-img.jpg') ?>"
                                alt="Profile"
                                class="rounded-circle"
                            />
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="news">
                                    <div class="post-item clearfix">
                                        <img
                                            src="<?= asset('admin/assets/img/news-1.jpg') ?>"
                                            alt=""
                                        />
                                        <h4>
                                            <a href="#"
                                    ...
                                    <div class="post-item clearfix">
                                        <img
                                            src="<?= asset('admin/assets/img/news-2.jpg') ?>"
                                            alt=""
                                        />
                                        <h4>
                                            <a href="#"
                                    ...
                                    <div class="post-item clearfix">
                                        <img
                                            src="<?= asset('admin/assets/img/news-3.jpg') ?>"
                                            alt=""
                                        />
                                        <h4>
                                            <a href="#"
                                    ...
                                    <div class="post-item clearfix">
                                        <img
                                            src="<?= asset('admin/assets/img/news-4.jpg') ?>"
                                            alt=""
                                        />
                                        <h4>
                                            <a href="#"
                                    ...
                                    <div class="post-item clearfix">
                                        <img
                                            src="<?= asset('admin/assets/img/news-5.jpg') ?>"
                                            alt=""
                                        />
                                        <h4>
                                            <a href="#"
